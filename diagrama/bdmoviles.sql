...
ALTER TABLE NOTIFICACION DROP FOREIGN KEY FKNOTIFICACI981960;
...
ALTER TABLE MENSAJES_CHAT DROP FOREIGN KEY FKMENSAJES_C709446;
...
CREATE TABLE NOTIFICACION (id int(10) NOT NULL AUTO_INCREMENT, id_tipo_notificacion int(10) NOT NULL, id_destinatario int(10), tipo_destinatario int(10), titulo varchar(255), mensaje varchar(255), fecha_creacion varchar(255), PRIMARY KEY (id));
...
Viernes
Sabado
Domingo', estado char(1) NOT NULL, PROGRAMACIONid int(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE ROL (id int(10) NOT NULL AUTO_INCREMENT, nombre varchar(255) NOT NULL, PRIMARY KEY (id));
CREATE TABLE DOMICILIO (id int(11) NOT NULL AUTO_INCREMENT, nombre varchar(255) NOT NULL, direccion varchar(255) NOT NULL, estado char(1) NOT NULL, PACIENTEid int(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE MENSAJES_CHAT (id int(10) NOT NULL AUTO_INCREMENT, id_chat int(10) NOT NULL, id_emisor int(10), tipo_emisor varchar(255), contenido varchar(255) NOT NULL, fecha_hora datetime NOT NULL, visto int(10), PRIMARY KEY (id));
CREATE TABLE CHAT (id int(10) NOT NULL AUTO_INCREMENT, fecha_creacion datetime NOT NULL, PACIENTEid int(10) NOT NULL, MEDICOid int(10) NOT NULL, PRIMARY KEY (id));
